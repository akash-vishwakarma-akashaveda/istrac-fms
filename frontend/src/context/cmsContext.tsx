...
export const DEFAULT_CMS_BLOCKS: Record<string, Record<string, unknown>> = {
  ...
  footer_custom: {
    brandTitle: 'ISRO ·',
    brandHighlight: 'ISTRAC',
    brandDescription: 'ISRO Telemetry, Tracking and Command Network · Department of Space, Government of India.',
    groundStations: 'BLR · SHAR · PBL · MAU · BIK · BYALALU',
    copyrightText: '© 2026 ISTRAC · Indian Space Research Organisation (ISRO).',
    quickLinks: 'Home, Reports, Calendar, Departments, About, Support',
    statusText: '24/7 Operations Live',
    portalBadge: 'Official Intranet Portal',
  },
  nav_footer: {
    brandSubtitle: 'ISRO Ground Network',
    groundStations: 'BLR · SHAR · PBL · MAU · BIK · BYALALU',
    footerCopyright: '© 2026 ISTRAC · Indian Space Research Organisation (ISRO).',
    footerQuickLinks: 'Home, Reports, Calendar, Departments, About, Support',
    copyrightText: '© 2026 ISTRAC · Indian Space Research Organisation (ISRO).',
