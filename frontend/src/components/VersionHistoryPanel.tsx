...
export function VersionHistoryPanel({
  ...
  return (
    <>
      ...
      <div
        aria-hidden="true"
        className={`fixed inset-0 z-[450] bg-page/85 backdrop-blur-[2px] transition-opacity duration-300 ${
      ...
      <div
        ...
        aria-hidden={!isOpen}
        className={`fixed top-0 right-0 z-[500] flex h-full w-full max-w-md flex-col border-l border-border-default bg-[#070d19] transition-transform duration-300 shadow-2xl ${
